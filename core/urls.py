...
urlpatterns = [
    ...
    path('business_and_economics_resources/', views.business_and_economics_resources, name='business_and_economics_resources'),
    path('health_and_wellness_resources/', views.health_and_wellness_resources, name='health_and_wellness_resources'),
    path('career_development_resource/', views.career_development_resource, name='career_development_resources'),
    # Community Support
    ...
    path('mental-health-resources/',views.mental_health_resources,name = 'mental_health_resources'),path('financial_assistance/',views.financial_assistance,name = 'financial_assistance'),
